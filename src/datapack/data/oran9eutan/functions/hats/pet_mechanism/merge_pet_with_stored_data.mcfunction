...
execute if data storage hats pet_data.Age run data modify entity @s CustomName set from storage minecraft:hats pet_data.CustomName
execute if data storage hats pet_data.Age run data modify entity @s CustomNameVisible set from storage minecraft:hats pet_data.CustomNameVisible
