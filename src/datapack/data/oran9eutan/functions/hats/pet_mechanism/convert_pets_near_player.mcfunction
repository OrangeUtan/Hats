...
execute as @e[type=minecraft:cat,tag=!global.ignore,distance=..2,predicate=oran9eutan:hats/entity/is_sitting] if data entity @s Owner run function oran9eutan:hats/pet_mechanism/convert_pet_to_hat_if_player_is_owner
