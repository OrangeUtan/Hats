...
# Tophats
execute as @s[scores={hats_rand_num=2}] run function hats:equip/tophats/brown
execute as @s[scores={hats_rand_num=3}] run function hats:equip/tophats/green
execute as @s[scores={hats_rand_num=4}] run function hats:equip/tophats/red
execute as @s[scores={hats_rand_num=5}] run function hats:equip/tophats/black
