...
# Tophats
execute if score #hats_rand hats_rand_num matches 1 run function hats:equip/tophats/white
execute if score #hats_rand hats_rand_num matches 2 run function hats:equip/tophats/orange
execute if score #hats_rand hats_rand_num matches 3 run function hats:equip/tophats/magenta
execute if score #hats_rand hats_rand_num matches 4 run function hats:equip/tophats/light_blue

# Glasses
execute if score #hats_rand hats_rand_num matches 5 run function hats:equip/glasses/half_rim
