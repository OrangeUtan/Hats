...
execute as @a[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet",tag:{Tags:["hats.hat"]}}]}] run function oran9eutan:hats/hat_mechanism/equip_player_with_correct_hat