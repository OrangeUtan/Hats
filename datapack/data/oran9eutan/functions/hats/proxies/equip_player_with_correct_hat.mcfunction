...
execute as @a[tag=!global.ignore] if predicate oran9eutan:hats/entity/wears_leather_helmet_hat run function oran9eutan:hats/hat_mechanism/equip_player_with_correct_hat