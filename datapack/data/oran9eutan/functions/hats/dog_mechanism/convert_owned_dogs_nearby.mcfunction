...
execute as @e[tag=!global.ignore,type=minecraft:wolf,distance=..2,nbt={Sitting:true}] if data entity @s Owner run function oran9eutan:hats/dog_mechanism/convert_dog_to_hat_if_player_is_owner