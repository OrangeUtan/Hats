...
execute if entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:leather_helmet",tag:{Tags:["is_hat"]}}]}] run schedule function hats:scheduled_proxies/equip_player_with_correct_hat 1t
