...
execute if predicate oran9eutan:hats/chests/chance_end_city_treasure at @e[type=area_effect_cloud,distance=..6,tag=hats.raycast.hit,limit=1] run function hats:insert_custom_loot_into_block
