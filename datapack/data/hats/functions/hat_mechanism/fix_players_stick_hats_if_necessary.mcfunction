...
data remove storage minecraft:hats buffer.all[{Slot:103b}]

execute if data storage minecraft:hats buffer.all[{id:"minecraft:stick", tag:{Tags:["is_hat"]}}] run function hats:hat_mechanism/fix_players_stick_hats
