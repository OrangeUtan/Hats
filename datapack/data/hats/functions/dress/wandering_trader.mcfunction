...
execute if predicate oran9eutan:hats/wandering_trader/chance_has_fav_cat run function hats:dress/wandering_trader/add_fav_cat

# Add optional Villager trade. This trade offers hats related to Villagers
execute if predicate oran9eutan:hats/wandering_trader/chance_has_villager_trade run function hats:dress/wandering_trader/add_villager_trade
