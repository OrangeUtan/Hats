...
loot replace entity @s weapon.offhand loot hats:hat_on_head/villager/_rand
data modify entity @s Offers.Recipes[-1].sell.tag set from entity @s HandItems[1].tag

# Set offer price
loot replace entity @s weapon.offhand loot hats:trades/wandering_trader/villager_price
